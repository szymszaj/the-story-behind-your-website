...
const projects = [
  {
    ...
    description:
      "A comprehensive e-commerce solution with real-time inventory management, secure payments, and a custom analytics dashboard. Built for scalability and performance.",
    image:
  ...
  },
  {
    ...
    description:
      "Intuitive personal finance dashboard for tracking expenses, investments, and savings goals. Features interactive charts and bank API integration.",
    image:
  ...
  },
  {
    ...
    description:
      "AI-powered platform helping marketers create SEO-optimized content in seconds. Includes multi-language support and tone customization.",
    image:
  ...
  },
  {
    ...
    category: "Web Design",
    description:
      "A sleek, performant portfolio website for a digital artist, featuring WebGL animations and a custom CMS for easy content updates.",
    image:
      "https://images.unsplash.com/photo-1545235617-9465d2a55698?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80",
    link: "#",
    tech: ["Three.js", "React", "Sanity", "GSAP"],
